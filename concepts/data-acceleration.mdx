...
<CardGroup cols={2}>
  <Card title="Acceleration Engines" icon="gears" href="/components/data-accelerators">
  ...
  <Card title="Snapshots Guide" icon="camera" href="/features/acceleration-snapshots">
