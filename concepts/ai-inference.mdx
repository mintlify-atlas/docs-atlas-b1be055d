...
See the [Evaluations cookbook](https://github.com/spiceai/cookbook/blob/trunk/evals/README.md) for detailed examples.
...
<CardGroup cols={2}>
  ...
  <Card title="Models" icon="cube" href="/ai/model-providers">
